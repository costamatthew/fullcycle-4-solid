class EmailNotificationServiceExample {
...
// Uso
const emailServiceExample = new EmailNotificationServiceExample();

// Enviando via SMTP
emailServiceExample.sendEmail("SMTP", "user1@example.com", "Hello via SMTP!");

// Enviando via AWS SES
emailServiceExample.sendEmail("SES", "user2@example.com", "Hello via SES!");

// Enviando via SendGrid
emailServiceExample.sendEmail("SendGrid", "user3@example.com", "Hello via SendGrid!");